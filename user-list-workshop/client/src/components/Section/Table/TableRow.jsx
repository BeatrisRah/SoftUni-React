    ...
    return(
        <tr>
            ...
            <td className="actions">
                <button className="btn edit-btn" title="Edit" onClick={() => props.onEdit(props.data._id)}>
                ...
                <button className="btn delete-btn" title="Delete" onClick={() => props.onDelete(props.data._id)} >
                ...
                <button className="btn info-btn" title="Info" onClick={() => props.onShow(props.data._id)} >
